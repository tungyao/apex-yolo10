...
from ultralytics10.hub.utils import HUB_WEB_ROOT, PREFIX, events
from ultralytics10.utils import LOGGER, SETTINGS
...
def on_fit_epoch_end(trainer):
    ...
    if session:
        ...
        if trainer.epoch == 0:
            from ultralytics10.utils.torch_utils import model_info_for_loggers
