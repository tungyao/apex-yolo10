...
def spaces_in_path(path):
    ...
    Example:
        ```python
        with ultralytics10.utils.files import spaces_in_path
...
def update_models(model_names=("yolov8n.pt",), source_dir=Path("."), update_names=False):
    ...
    Example:
        ```python
        from ultralytics10.utils.files import update_models
    ...
    from ultralytics10.nn.autobackend import default_class_names
