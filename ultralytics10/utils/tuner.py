...
from ultralytics10.cfg import TASK2DATA, TASK2METRIC, get_save_dir
from ultralytics10.utils import DEFAULT_CFG, DEFAULT_CFG_DICT, LOGGER, NUM_THREADS, checks
