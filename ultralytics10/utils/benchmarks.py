...
Usage:
    from ultralytics10.utils.benchmarks import ProfileModels, benchmark
...
from ultralytics10 import YOLO, YOLOWorld
from ultralytics10.cfg import TASK2DATA, TASK2METRIC
from ultralytics10.engine.exporter import export_formats
from ultralytics10.utils import ASSETS, LINUX, LOGGER, MACOS, TQDM, WEIGHTS_DIR
from ultralytics10.utils.checks import IS_PYTHON_3_12, check_requirements, check_yolo
from ultralytics10.utils.files import file_size
...
class ProfileModels:
    ...
    Example:
        ```python
        from ultralytics10.utils.benchmarks import ProfileModels
