...
def entrypoint(debug=""):
    """
    This function is the ultralytics10 package entrypoint, it's responsible for parsing the command line arguments passed
    to the package.
    ...
    if "rtdetr" in stem:  # guess architecture
        from ultralytics10 import RTDETR

        model = RTDETR(model)  # no task argument
    elif "fastsam" in stem:
        from ultralytics10 import FastSAM
