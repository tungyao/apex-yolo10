...
from ultralytics10.nn.modules import (
    AIFI,
    C1,
    C2,
    C3,
...
from ultralytics10.utils import DEFAULT_CFG_DICT, DEFAULT_CFG_KEYS, LOGGER, colorstr, emojis, yaml_load
from ultralytics10.utils.checks import check_requirements, check_suffix, check_yaml
from ultralytics10.utils.loss import v8ClassificationLoss, v8DetectionLoss, v8OBBLoss, v8PoseLoss, v8SegmentationLoss, v10DetectLoss
from ultralytics10.utils.plotting import feature_visualization
from ultralytics10.utils.torch_utils import (
    fuse_conv_and_bn,
    fuse_deconv_and_bn,
    initialize_weights,
    intersect_dicts,
...
class RTDETRDetectionModel(DetectionModel):
    ...
    def init_criterion(self):
        ...
        from ultralytics10.models.utils.loss import RTDETRDetectionLoss
...
def torch_safe_load(weight):
    ...
    """
    from ultralytics10.utils.downloads import attempt_download_asset
    ...
    try:
        with temporary_modules(
            {
                "ultralytics10.yolo.utils": "ultralytics10.utils",
                "ultralytics10.yolo.v8": "ultralytics10.models.yolo",
                "ultralytics10.yolo.data": "ultralytics10.data",
            }
        ...
        if e.name == "models":
            raise TypeError(
                emojis(
                    ...
                    f"\nRecommend fixes are to train a new model using the latest 'ultralytics10' package or to "
                    f"run a command with an official YOLOv8 model, i.e. 'yolo predict model=yolov8n.pt'"
                )
            ) from e
        LOGGER.warning(
            f"WARNING ⚠️ {weight} appears to require '{e.name}', which is not in ultralytics10 requirements."
