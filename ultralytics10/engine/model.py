...
from ultralytics10.cfg import TASK2DATA, get_cfg, get_save_dir
from ultralytics10.hub.utils import HUB_WEB_ROOT
from ultralytics10.nn.tasks import attempt_load_one_weight, guess_model_task, nn, yaml_model_load
from ultralytics10.utils import ASSETS, DEFAULT_CFG_DICT, LOGGER, RANK, SETTINGS, callbacks, checks, emojis, yaml_load
...
class Model(nn.Module):
    ...
    def __call__(
        ...
        **kwargs,
        ...
        Returns:
            (List[ultralytics10.engine.results.Results]): A list of prediction results, encapsulated in the Results class.
        """
    ...
    def _get_hub_session(model: str):
        ...
        from ultralytics10.hub.session import HUBTrainingSession
    ...
    def reset_weights(self) -> "Model":
        ...
        Returns:
            self (ultralytics10.engine.model.Model): The instance of the class with reset weights.
    ...
    def load(self, weights: Union[str, Path] = "yolov8n.pt") -> "Model":
        ...
        Returns:
            self (ultralytics10.engine.model.Model): The instance of the class with loaded weights.
    ...
    def predict(
        ...
        **kwargs,
        ...
        is_cli = (sys.argv[0].endswith("yolo") or sys.argv[0].endswith("ultralytics10")) and any(
    ...
    def track(
        ...
        **kwargs,
        ...
        Returns:
            (List[ultralytics10.engine.results.Results]): A list of tracking results, encapsulated in the Results class.

        Raises:
            AttributeError: If the predictor does not have registered trackers.
        """
        if not hasattr(self.predictor, "trackers"):
            from ultralytics10.trackers import register_tracker
    ...
    def benchmark(
        ...
        **kwargs,
        ...
        It uses the 'benchmark' function from the ultralytics10.utils.benchmarks module. The benchmarking is configured
        ...
        The method supports various arguments that allow customization of the benchmarking process, such as datasets
        ...
        """
        self._check_is_pytorch_model()
        from ultralytics10.utils.benchmarks import benchmark
    ...
    def tune(
        ...
        **kwargs,
        ...
        When Ray Tune is enabled, it leverages the 'run_ray_tune' function from the ultralytics10.utils.tuner module.
        ...
        self._check_is_pytorch_model()
        if use_ray:
            from ultralytics10.utils.tuner import run_ray_tune
    ...
    def names(self) -> list:
        ...
        using the 'check_class_names' function from the ultralytics10.nn.autobackend module.

        Returns:
            (list | None): The class names of the model if available, otherwise None.
        """
        from ultralytics10.nn.autobackend import check_class_names
