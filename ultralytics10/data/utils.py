...
from ultralytics10.utils.checks import check_file, check_font, is_ascii
from ultralytics10.utils.downloads import download, safe_download, unzip_file
from ultralytics10.utils.ops import segments2boxes

HELP_URL = "See https://docs.ultralytics.com/datasets/detect for datasets formatting guidance."
...
class HUBDatasetStats:
    ...
    Example:
        ...
        ```python
        from ultralytics10.data.utils import HUBDatasetStats
    ...
    def get_json(self, save=False, verbose=False):
        ...
        for split in "train", "val", "test":
            ...
            if self.task == "classify":
                ...
                from ultralytics10.data import YOLODataset
    ...
    def process_images(self):
        ...
        from ultralytics10.data import YOLODataset  # ClassificationDataset
...
def compress_one_image(f, f_new=None, max_dim=1920, quality=50):
    ...
    Example:
        ```python
        from pathlib import Path
        from ultralytics10.data.utils import compress_one_image
...
def autosplit(path=DATASETS_DIR / "coco8/images", weights=(0.9, 0.1, 0.0), annotated_only=False):
    ...
    Example:
        ```python
        from ultralytics10.data.utils import autosplit
