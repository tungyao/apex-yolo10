...
from ultralytics10.utils import LOGGER, colorstr
from ultralytics10.utils.checks import check_version
from ultralytics10.utils.instance import Instances
from ultralytics10.utils.metrics import bbox_ioa
from ultralytics10.utils.ops import segment2box, xyxyxyxy2xywhr
from ultralytics10.utils.torch_utils import TORCHVISION_0_10, TORCHVISION_0_11, TORCHVISION_0_13
...
class BaseMixTransform:
    ...
    def __init__(self, dataset, pre_transform=None, p=0.0) -> None:
        """Initializes the BaseMixTransform object with datasets, pre_transform, and probability."""
...
class MixUp(BaseMixTransform):
    """Class for applying MixUp augmentation to the datasets."""

    def __init__(self, dataset, pre_transform=None, p=0.0) -> None:
        """Initializes MixUp object with datasets, pre_transform, and probability of applying MixUp."""
